...
| [8주](/weeks/week-08/) | **프로젝트 계획 발표 (중간고사 대체)** | 개인 캡스톤 계획서 발표 — 시험 없음 |
| [9주](/weeks/week-09/) | 플래너 에이전트(2단계 분리), QA 독립성 원칙, 자동 테스트 파이프라인 | 플래너 + QA 에이전트 구현 (Lab 09) |
...
| 주차 | 내용 |
|------|------|
| [13주](/weeks/week-13/) | 개인 프로젝트 착수, 아키텍처 설계 문서 (8주차 계획서 확장) |
