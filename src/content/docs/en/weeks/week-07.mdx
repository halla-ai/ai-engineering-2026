...
<Aside type="note" title="MCP Transport Evolution: SSE → Streamable HTTP">
...
| **Cost** | API tokens only | API tokens only | <strong>$0.08/session-hour</strong> + tokens |
...
- [AG-UI Protocol](https://docs.ag-ui.com/introduction) — Agent↔user UI real-time streaming protocol. Started at CopilotKit, integrated with LangGraph/CrewAI/Microsoft
- [Anthropic Managed Agents](https://platform.claude.com/docs/en/managed-agents/overview) — Cloud-hosted agent infrastructure. $0.08/session-hour, public beta (2026-04)
- [Claude Code Agent Teams](https://code.claude.com/docs/en/agent-teams) — Native team mode. Independent contexts, direct communication, split-pane display
