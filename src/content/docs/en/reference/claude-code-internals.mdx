...
| **Conditional** | 18 | Agent Tool, Skills, Memory, MCP Instructions, Git Status, Token Budget, Verification Agent, etc. |
...
**4. Token Budget** — Specifying a budget like `+500k` makes the model continue working until that budget is exhausted. **Autonomy controlled at the token level** for long-running sessions.
...
| **Week 12** | Token Budget = runtime control of cost/quality trade-offs |
